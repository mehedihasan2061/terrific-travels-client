...
const About = () => {
    return (
      <div>
        ...
        <div>
          <p className="my-3">
            <span className="text-xl font-bold">Adventure and Discovery:</span>{" "}
          ...
          <p>
            ...
            Travel challenges you to step out of your comfort zone, adapt to new
            environments, and solve unexpected problems. This can significantly
            contribute to your personal development, boosting confidence,
          ...
          <p className="my-3">
            ...
            participating in thrilling activities. These moments create lasting
          ...
          <p className="my-3">
            ...
            over the world. These connections can enrich your life, expand your
            network, and sometimes lead to lifelong friendships.
          </p>
          <p className="my-3">
            <span className="text-xl font-bold ">Nature and Wildlife:</span> For
            nature enthusiasts, travel offers a chance to witness diverse
